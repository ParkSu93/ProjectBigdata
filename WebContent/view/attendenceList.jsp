							...
							<h3 class="panel-title">
								...
								<div class="pull-right text-center">
									<span class="panel-title btn-group">
										<button id="storeUser" ng-disabled="underCreation"
											type="button" class="btn btn-default btn-sm"
											ng-click="addUser()" style="padding-left: 10px">
											<span
												class="glyphicon glyphicon-exclamation-sign  text-primary"></span>
											<span class="text-primary"><strong>저장</strong></span>
										</button>
									</span>
								</div>
								<div class="pull-right text-center">
									<span class="panel-title btn-group">
										<button id="checkUser" ng-disabled="underCreation"
											type="button" class="btn btn-default btn-sm"
											ng-click="addUser()" style="padding-right: 10px">
											<span class="glyphicon glyphicon-user  text-primary"></span>
											<span class="text-primary"><strong>일괄출석</strong></span>
										</button>
									</span>
								</div>
							</h3>
							...
							for (var j = first_index; j < (attend_student_list.length); j++) { // 전체 리스트에 대해서 
								...
								while (i++ < day_num) {
									if (now_student.attendance_status[i] != null) {// 출결정보 있을때
										th_tr
												.append('<td><input type="text" class="td_day td_'+i+'_day" value ='now_student.attendance_status[i]'/></td>');
									} else { // 출결정보 없을때 빈칸
										th_tr
